...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{SoftGray}{医学人工智能}}
...
\hypersetup{
  ...
  pdftitle={医学人工智能课程项目设计说明}
}
\usepackage{bookmark}
\IfFileExists{xurl.sty}{\usepackage{xurl}}{} % add URL line breaks if available
\urlstyle{same}
\hypersetup{
  pdftitle={《医学人工智能》课程项目设计说明},
  pdfauthor={苏易文张崇洋廖晨皓},
  pdflang={zh-CN},
  colorlinks=true,
  linkcolor={Maroon},
...
\pandocbounded{\includegraphics[keepaspectratio,alt={系统总体架构}]{assets/system-architecture.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={未来多智能体愿景}]{assets/future-multi-agent-vision.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={问诊数据流}]{assets/interaction-flow.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={系统首页}]{../assets/ui-home.png}}

\pandocbounded{\includegraphics[keepaspectratio,alt={问诊后摘要界面}]{../assets/ui-chat-summary.png}}

可以看出，UI 的重点不是装饰，而是信息组织。左侧对话区负责降低输入门槛，右侧摘要区负责提高阅读效率。特别是``仍待补充信息''下面做了快捷补全按钮，这个设计很像把医生追问模板嵌到了前端里，能让下一轮输入更有方向。

下面这张是挂号工作台截图：

\pandocbounded{\includegraphics[keepaspectratio,alt={模拟挂号工作台}]{../assets/ui-booking-modal.png}}
